// Package ids defines the core 64-bit entity/pair ID type for the flecs ECS.
// It is a dependency-free leaf package so that both the root flecs package and
// internal subpackages (table, entityindex, component) can import it without
// forming import cycles.
package ids
