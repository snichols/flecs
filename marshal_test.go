...
// the 29 built-in entities plus all registered component entities.
func nonDataEntities(w *flecs.World) map[flecs.ID]struct{} {
	skip := map[flecs.ID]struct{}{
		...
		w.Reflexive(): {}, w.Acyclic(): {}, w.Final(): {}, w.OneOf(): {}, w.Singleton(): {}, w.WriteOnce(): {}, w.Traversable(): {}, w.Wildcard(): {}, w.Any(): {},
	}
