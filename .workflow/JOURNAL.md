...
Fixed gofmt violation in query_terms_test.go: replaced inline anonymous struct literals with a named type (selfResult) in TestQuerySelfUp_CachedWithLocalAndInherited. golangci-lint and tests now clean.
